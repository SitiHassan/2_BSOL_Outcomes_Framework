...
Create a temporary table for each combination and union all 4 additional datasets with the dataset built previously. Then, insert them into the final destination table. 
